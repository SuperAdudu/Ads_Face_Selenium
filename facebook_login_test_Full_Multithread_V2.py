...
listAccount = ["neptune00002@gmail.com","prometi.mr.2022@gmail.com",
                   "dubni66@gmail.com","mercury.mr.2022@gmail.com"]
lock = threading.Lock()
# Thời gian bắt đầu
start_time = time.time()
# Thời gian chạy của vòng lặp (24 giờ = 86400 giây)
loop_duration = 24 * 60 * 60
...
def loginfb(browser, link, account):
    browser.get(link)
    wait1 = WebDriverWait(browser, 30)  # Maximum wait time of 10 seconds
    username = wait1.until(EC.visibility_of_element_located((By.XPATH,
                                                             '//*[@id="email"]')))
    sleep(randint(5, 7))
    username.send_keys(account)
    #username.send_keys("saturnlle01@gmail.com")
    wait2 = WebDriverWait(browser, 30)  # Maximum wait time of 10 seconds
    password = wait2.until(EC.visibility_of_element_located((By.XPATH,
                                                             '//*[@id="pass"]')))
    sleep(randint(5, 7))
    password.send_keys("Vietnam@3i")
    sleep(20)
    try:
        wait3 = WebDriverWait(browser, 30)  # Maximum wait time of 10 seconds
        login = wait3.until(EC.element_to_be_clickable((By.XPATH, "//button[text()='Log in']")))
        sleep(randint(5, 7))
        login.click()
    except:
        wait3 = WebDriverWait(browser, 30)  # Maximum wait time of 10 seconds
        login = wait3.until(EC.element_to_be_clickable((By.XPATH, "//button[text()='Đăng nhập']")))
        sleep(randint(5, 7))
        login.click()
    ...
    clickGroup = wait4.until(EC.element_to_be_clickable((By.XPATH, '//a[@aria-label="Nhóm"]')))
    clickGroup.click()
    sleep(5)
    wait5 = WebDriverWait(browser, 10)  # Maximum wait time of 10 seconds
    clickGroup = wait5.until(
            EC.element_to_be_clickable((By.XPATH, '//a[@href="/groups/joins/?nav_source=tab" and @role="link"]')))
    clickGroup.click()
    sleep(5)
    ...
    elementTo = wait.until(
            EC.visibility_of_element_located(
                (By.XPATH, "//div[@aria-label='Danh sách nhóm' and @role='navigation']")))
    print("div to 1 into")
    browser.implicitly_wait(10)
    element = elementTo.find_elements(By.XPATH, '//div[starts-with(@class, "x9f619 x1n2onr6 x1ja2u2z")]/a')
            ...
            if ez >2:
                try:
                        ...
                        eachGroup = wait6.until(
                                EC.element_to_be_clickable((By.XPATH, f'(//a[@href="{href}" and @role="link"])[1]')))
                        eachGroup.click()
                        print('passsssssss1x')
                        ...
                        try:
                            ...
                            close = browser.find_element(By.XPATH,
                                                        f'//div[@aria-label="Rời khỏi Trang" and @role="button"]').click()
                        except:
                            try:
                                browser.implicitly_wait(5)
                                close = browser.find_element(By.XPATH,
                                                            f'//div[@aria-label="Leave Page" and @role="button"]').click()
                            except:
                        ...
                        try:
                            browser.implicitly_wait(5)
                            close = browser.find_element(By.XPATH,
                                                        f"//div[@aria-label='Đóng']").click()
                        except:
                            try:
                                browser.implicitly_wait(5)
                                close = browser.find_element(By.XPATH,
                                                            f"//div[@aria-label='Close']").click()
                            except:
                        ...
                        try:
                            ...
                            GroupFeed = wait7.until(
                                EC.visibility_of_element_located
                                ((By.XPATH, "//div[@data-pagelet='GroupFeed']")))
                        except:
                            wait7 = WebDriverWait(i, 10)
                            GroupFeed = wait7.until(
                                EC.visibility_of_element_located
                                ((By.XPATH, '//div[@aria-label="Bản xem trước nhóm" and @role="main"]')))
                        print('passsssssss1x')
                        ...
                        feedx = wait9.until(
                            ...
                            ((By.XPATH, "//*[contains(concat(' ', @class, ' '), 'x1yztbdb x1n2onr6 xh8yej3 x1ja2u2z')]")))
                        print('passsssssss1x')
                        ...
                        try:
                            ...
                            eachGroup = wait6.until(
                                EC.element_to_be_clickable((By.XPATH, f'(//a[@href="{href}" and @role="link"])')))
                            eachGroup.click()
                            print('passsssssss2x')
                            # dosomething
                            # Check popup "Rời khỏi Trang"
                            ...
                            for i in feedx:
                                ...
                                try:
                                    ...
                                    try:
                                        browser.implicitly_wait(5)
                                        restricted = browser.find_element(By.XPATH, "//div[@style='display: inline;']")
                                        print("Restricted")
                                        ...
                                        try:
                                            browser.implicitly_wait(5)
                                            restricted = browser.find_element(By.XPATH, "//span[text()='Giờ bạn chưa dùng được tính năng này']")
                ...
                try:
                        ...
                        for i in feedx:
                            ...
                            try:
                                ...
                                browser.implicitly_wait(10)
                                commentDe0 = i.find_element(By.XPATH,"//div[@aria-label='Viết bình luận' and @role='button']")
                                browser.execute_script("arguments[0].click();", commentDe0)
                                browser.implicitly_wait(10)
                                commentDe = i.find_element(By.XPATH,'//div[@aria-label="Viết bình luận công khai…"]')
                                commentDe.send_keys("http://leduymanh.com/vi/elementor-1226/")
                                sleep(randint(5, 6))
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        restricted = browser.find_element(By.XPATH,
                                                                          "//span[text()='Giờ bạn chưa dùng được tính năng này']")
                                        print("Restricted All")
                                        try:
                                            browser.implicitly_wait(5)
                                            close = browser.find_element(By.XPATH,
                ...
                try:
                        ...
                        for i in feedx:
                            ...
                            try:
                                ...
                                print("DaClickShare")
                                browser.implicitly_wait(10)
                                shareNhomDe = i.find_element(By.XPATH,'//span[text()="Chia sẻ lên nhóm"]')
                                browser.execute_script("arguments[0].click();", shareNhomDe)
                                print("DaClickShareNhom")
                                sleep(randint(2, 4))

                                browser.implicitly_wait(10)
                                share1NhomDe = i.find_element(By.XPATH,f"(//div[@role='listitem'])[{izzz}]")
                                ...
                                browser.implicitly_wait(10)
                                shareCntNhomDe = i.find_element(By.XPATH,"//*[@aria-label='Tạo bài viết công khai...']")
                                shareCntNhomDe.send_keys("http://leduymanh.com/vi/elementor-1226/")
                                print("DaClickCntNhom")
                                sleep(randint(3, 5))
                                
                                browser.implicitly_wait(10)
                                sharePstNhomDe = i.find_element(By.XPATH,'//div[@aria-label="Đăng" and @role="button"]')
                                browser.execute_script("arguments[0].click();", sharePstNhomDe)
                                print("DaClickPstNhom")
                                sleep(randint(10, 13))
                                with open("logGroupLike.txt", "a") as file:
                                    file.write(f"So Share: {izzz} \nLink: {href}")
                                izzz+=1
                                # Lấy Xpath Restricted POST
                                try:
                                    browser.implicitly_wait(5)
...
def post2(browser, account, postContent):
        ...
        for i in range(ez,len(element)):
            ...
            ez += 1
def seach_addGroup(browser):
        wait4 = WebDriverWait(browser, 10)  # Maximum wait time of 10 seconds
        #Eng
        #search = wait4.until(EC.visibility_of_element_located((By.XPATH,
        ...
        wait5 = WebDriverWait(browser, 10)  # Maximum wait time of 10 seconds
        #eng
        #seeall = wait5.until(EC.element_to_be_clickable((By.XPATH,'//a[@aria-label="See all"]')))
        #vie
        seeall = wait5.until(EC.element_to_be_clickable((By.XPATH, '//a[@aria-label="Xem tất cả"]')))
        seeall.click()
        sleep(5)
        i = 1
        ...
        while True:
                try:
                    if i >10:
                        break
                    wait6 = WebDriverWait(browser, 10)  # Maximum wait time of 10 seconds
                    #eng
                    seeall2 = wait6.until(EC.element_to_be_clickable((By.XPATH, f'(//span[contains(text(),"Join")])[{i}]')))
                    #vie
                    seeall2 = wait6.until(EC.element_to_be_clickable((By.XPATH, f'(//span[contains(text(),"Tham gia")])[{i}]')))
                    seeall2.click()
                    #browser.execute_script("window.scrollBy(0, document.documentElement.scrollHeight);")
                    sleep(5)
                    try:
                        wait7 = WebDriverWait(browser, 3)
                        # Cái này xuất hiện thì click nó
                        close_button = wait7.until(EC.element_to_be_clickable((By.XPATH, '//div[@aria-label="Close"]')))
                        close_button.click()
                    except Exception as e:
                        pass
                    i+=1
...
if __name__ == '__main__':
   main('Hãy làm việc với đam mê và không bao giờ từ bỏ. Bởi vì nếu bạn làm điều bạn thích, bạn sẽ không bao giờ phải làm việc một ngày nào trong đời.')
#seach_addGroup(browser)
#scanUser(browser)
#post(browser)
#post2(browser)
#autoLike(browser)
